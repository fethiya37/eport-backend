...
exports.PrismaTokenRepository = void 0;
const common_1 = require("@nestjs/common");
const prisma_service_1 = require("../../../prisma/prisma.service");
let PrismaTokenRepository = class PrismaTokenRepository {
    prisma;
    constructor(prisma) {
        this.prisma = prisma;
    }
    async revoke(jti, user_id, expires_at) {
...
//# sourceMappingURL=prisma-token.repository.js.map
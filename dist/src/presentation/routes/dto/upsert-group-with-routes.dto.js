...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 5, description: 'Use existing group if provided; else a new group will be created from route_group' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Addis – Adama Corridor', description: 'Required only when creating a new group (no route_group_id supplied)' }),
    (0, class_validator_1.IsOptional)(),
